...
public class CircularLinkedList{
	...
	/*
	 * public static void main(String [] args){ CircularLinkedList list = new
	 * CircularLinkedList(); list.pushFront(10); list.pushBack(12);
	 * list.pushFront(8); list.pushBack(14);
	 * 
	 * list.display();
	 * 
	 * list.popFront(); list.display();
	 * 
	 * list.popBack(); list.display(); list.popFront(); list.popBack();
	 * list.display(); }
	 */
}
